...
background:#F7EEC5;	
  ...
  <body>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
						<form action="" method="POST">
							<div class="row">
							  <div class="col-2">
								<label for="inputPassword6" class="col-form-label"><b>Numero</b></label>
											  ...
											  <legend class="reset">Consulta Bienes</legend>
												<div class="row mt-3">
													...
													<div class="form-group col-sm-6">
													  <select class="form-select" id="idBien" name="bien">
													      <option value=" ">[Seleccione Bien]</option>
													  </select>
													</div>
													<div class="col-sm-4">
														<button id="btn-consultar-tipo" type="button" class="btn btn-info">
	...
	<script>
		...
		$('#tableSolicitados').dataTable( {
				  "searching": false,
				  "lengthChange": false,
				  responsive: true,		  
		} );
				
		$(document).on("click","#btn-consultar-tipo",function(){
			let codtipo;
			codTipo=0;
			$.get(""+codTipo,function(response){
